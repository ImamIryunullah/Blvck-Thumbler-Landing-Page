        ...
        <div className="bg-[#1B1F24] relative flex flex-col justify-center">
          ...
          >
            ...
            >
              Black
              <br />
              <div className="text-yellow-600"> Thumbler</div>
            </h1>
        ...
        <div className="bg-[#262C33] relative overflow-hidden flex flex-col justify-center">
          ...
          <div className="md:hidden flex justify-center mt-10">
            <motion.img
              ...
              src={Bottle}
              alt="Hero Bottle"
              className="w-[200px] drop-shadow-[0_0_30px_rgba(255,255,255,0.15)]"
            />
          </div>

          {/* BACKGROUND TEXT (DESKTOP ONLY) */}
          <h2 className="hidden md:block absolute top-4 left-1/2 -translate-x-1/2 text-[140px] lg:text-[180px] font-extrabold text-black/20 select-none whitespace-nowrap">
            BLACK
          </h2>

          <h2 className="hidden md:block absolute top-56 right-14 text-[100px] font-extrabold text-black/15 select-none">
            THUMBLER
          </h2>
          ...
          <motion.div
            ...
            className="z-10 px-6 py-12 md:px-16 md:py-0 lg:px-20"
          >
            ...
            <button className="mt-6 w-fit text-white text-sm md:text-base border-b border-gray-400 hover:border-yellow-600 transition">
              Explore the product →
            </button>
          </motion.div>
        </div>
